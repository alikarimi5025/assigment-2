...
void Deck::insert(vector<Card> &cardlist, Card card) {
    ...
    // when the for lop finishes the index j will be position where the new card should be inserted

    cardlist.insert(cardlist.begin() + j, card);// insert the new card at the position
